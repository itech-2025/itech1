...
const NewsDetail = () => {
  ...
  return (
    <> {/*news header*/}
        ...
        namestyle='px-4 py-1 bg-gray-100 rounded-lg gap-2.5 overflow-hidden text-gray-900 font-normal leading-normal tracking-tight lg:!text-2xl md:!text-xl !text-sm'
      /> {/*navigation*/}
       <div dir='ltr' className="flex md:flex-row flex-col justify-between items-center md:gap-0 gap-15 mt-10 lg:px-20 md:px-10 px-5">
            ...
            <li onClick={handleprev} className="group cursor-pointer flex flex-col md:items-end items-center text-center">
                <button className={`${i18next.language==='en'?"w-25":"w-18"} cursor-pointer text-lg font-light font-['Montserrat-Arabic'] border-b pb-2 border-b-primary-1 hover:border-b-primary-2 overflow-hidden`}>
